...
if(isset($_POST["submit"])) {
   ...
   prof_update_d($_SESSION['email'],$_SESSION['password'],$target_file,'img');
}
if(isset($_POST['submit2'])){
if($_POST['pas1']==$_POST['pas2']){
    prof_update_d($_SESSION['email'],$_SESSION['password'],$_POST['pas1'],'password');
...
<h3><?php nav_doc_item($_SESSION['email'],$_SESSION['password'],'doctorName');?></h3>

<img src="../admins/<?php nav_doc_item($_SESSION['email'],$_SESSION['password'],'doc_img');?>" alt="img here" style=" width: 29rem;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
height: 25rem;">
