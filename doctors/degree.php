...
if(isset($_GET['check_list'])){
    ...
    foreach($_GET['check_list'] as $index => $selected){
        // echo $selected."</br>";
        // echo $_GET['stu_id1'][$index]."</br>";
        // echo $_GET['selected_type'][$index]."mmm</br>";
        find_stu($_SESSION['email'],$_SESSION['password'],$_GET['stu_id1'][$index],$_GET['sub_id1'][$index],
        $_GET['selected_type'][$index],$selected,$_GET['degree'][$index]);
...
<form action="degree.php" method="get">
...
//Get_subjects($_SESSION['email'],$_SESSION['password']);
  ...
  <thead>
    <tr>
      ...
      <!-- <th scope="col">failed/successful</th> -->
...
Set_Marks($_SESSION['email'],$_SESSION['password'],1);
...
Set_Marks($_SESSION['email'],$_SESSION['password'],2);
...
Set_Marks($_SESSION['email'],$_SESSION['password'],3);
...
Set_Marks($_SESSION['email'],$_SESSION['password'],4);
...
Set_Marks($_SESSION['email'],$_SESSION['password'],5);
